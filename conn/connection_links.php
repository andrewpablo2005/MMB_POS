...
<link rel="stylesheet" href="<?= mmbpos_base_path() ?>/css/mmb-theme.css?v=3.4">
...
<!-- Global help layer (curated hover tooltips + "?" chips where staff need them) -->
<script src="<?= mmbpos_base_path() ?>/js/mmb-tooltips.js?v=7"></script>
